      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <div className="relative flex-shrink-0 mt-16 lg:mt-0">
            ...
            {/* Cards Container - Positioned above phone on mobile, overlapping on desktop */}
            <div className="relative flex justify-center items-center mb-4 lg:mb-0 lg:absolute lg:-top-8 lg:left-1/2 lg:-translate-x-1/3 z-10" style={{ minHeight: '320px' }}>
              
              {/* Card 1: PT */}
              <div 
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-all duration-300 ease-out hover:z-50 hover:!transform hover:!rotate-0 hover:!translate-x-0 hover:!-translate-y-4 hover:scale-105"
                style={{ 
                  zIndex: 10, 
              ...
              <div 
                ...
                style={{ 
                  zIndex: 15, 
                  transform: 'rotate(-6deg) translateX(-40px) translateY(0px)',
                  boxShadow: '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)'
                }}
              >
                <div className="p-3">
              ...
              <div 
                ...
                style={{ 
                  zIndex: 14, 
                  transform: 'rotate(8deg) translateX(80px) translateY(10px)',
                  boxShadow: '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)'
                }}
              >
                <div className="p-3">
              ...
              <div 
                ...
                style={{ 
                  zIndex: 11, 
                  transform: 'rotate(14deg) translateX(140px) translateY(30px)',
                  boxShadow: '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)'
                }}
              >
                <div className="p-3">
            ...
            {/* Phone Frame - Same size as journaling phone */}
            <div 
              className="relative bg-gray-800 rounded-[2.5rem] p-2 mx-auto lg:mx-0 lg:mt-48"
              style={{ 
                width: '260px',
                boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 12px 24px -8px rgba(0, 0, 0, 0.1)' 
              }}
              ...
              <div className="bg-white rounded-[2rem] overflow-hidden">
                ...
                <div className="p-3 bg-gradient-to-b from-amber-50/50 to-white">
                  <svg viewBox="0 0 200 200" className="w-full h-auto">
                    ...
                    {/* Labels */}
                    <text x="100" y="18" textAnchor="middle" className="fill-gray-600" fontSize="8">Communication</text>
                    <text x="168" y="58" textAnchor="start" className="fill-gray-600" fontSize="8">Social</text>
                    <text x="175" y="103" textAnchor="start" className="fill-gray-600" fontSize="8">Sensory</text>
                    <text x="158" y="158" textAnchor="start" className="fill-gray-600" fontSize="8">Behavior</text>
                    <text x="100" y="185" textAnchor="middle" className="fill-gray-600" fontSize="8">Cognitive</text>
                    <text x="25" y="158" textAnchor="start" className="fill-gray-600" fontSize="8">Motor</text>
                    <text x="5" y="103" textAnchor="start" className="fill-gray-600" fontSize="8">Self-Care</text>
                  </svg>
                </div>
