...
const SolutionSection: React.FC = () => {
  ...
  const isPTActive = activeCard === 'PT';
  const isOTActive = activeCard === 'OT';
  const isSALTActive = activeCard === 'SALT';
  const isABAActive = activeCard === 'ABA';
  const isBIOMEDActive = activeCard === 'BIOMED';

  return (
    <section className="py-12 md:py-20 overflow-hidden bg-gradient-to-b from-white to-gray-50/50">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        {/* Headline */}
        <div className="text-center mb-10 md:mb-16">
          <h2 className="text-2xl md:text-4xl lg:text-5xl text-gray-900 leading-tight max-w-4xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
          ...
          <div className="relative flex-shrink-0">
            <div className="relative">
              {/* Phone Frame */}
              <div
                className="relative bg-gray-800 rounded-[2.5rem] p-2"
                style={{
                  width: '260px',
                  boxShadow:
                    ...
                    <div className="bg-gray-50 rounded-xl p-3 space-y-2">
                      ...
                      <div className="space-y-2">
                        <div className="bg-white rounded-lg p-2 flex items-center justify-between border border-gray-100">
                          <div>
                            <p className="text-[11px] font-medium text-gray-800">
                              Sleep Disruption and Sugar Cravings
                            </p>
                        ...
                        <div className="bg-white rounded-lg p-2 flex items-center justify-between border border-gray-100">
                          <div>
                            <p className="text-[11px] font-medium text-gray-800">
                              Improvement in Sensory Responses
                            </p>
                            <p className="text-[9px] text-gray-400">Jan 30th, 2026</p>
                          </div>
                          <div className="w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center">
          ...
          {/* RIGHT: Insights Phone + Cards */}
          <div className="relative flex-shrink-0 mt-16 lg:mt-0">
            {/* Cards Container - bottom-sheet style overlapping phone on all breakpoints */}
            <div
              className="absolute inset-x-0 bottom-6 flex justify-center items-center z-20"
              style={{ minHeight: '320px' }}
            >
              {/* Card 1: PT */}
              <div
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-transform duration-300 ease-out"
                onMouseEnter={() => setActiveCard('PT')}
                onMouseLeave={() => setActiveCard(null)}
                onClick={() => setActiveCard('PT')}
                style={{
                  zIndex: isPTActive ? 50 : 10,
                  transform: isPTActive
                    ? 'translateY(-16px) scale(1.05)'
                    : 'rotate(-15deg) translateX(-100px) translateY(20px)',
                  boxShadow:
                    '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)',
                }}
              >
                <div className="p-3">
                  ...
                  <div className="space-y-1.5">
                    <div className="bg-blue-50 rounded-lg p-1.5">
                      ...
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Significant gross motor improvements—9 consecutive basketball shots.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-1.5">
                      ...
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Swimming shows improved core stability.
                      </p>
                    </div>

                    <div className="bg-blue-50/50 rounded-lg p-1.5 border border-blue-100 border-dashed">
                      <p className="text-[7px] font-medium text-blue-600">Proposed Strategy #1</p>
                    </div>
                  </div>

                  <div className="mt-2 flex items-center gap-1.5">
                    <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-4/5 bg-gradient-to-r from-blue-400 to-blue-500 rounded-full" />
                    </div>
              ...
              <div
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-transform duration-300 ease-out"
                onMouseEnter={() => setActiveCard('OT')}
                onMouseLeave={() => setActiveCard(null)}
                onClick={() => setActiveCard('OT')}
                style={{
                  zIndex: isOTActive ? 50 : 15,
                  transform: isOTActive
                    ? 'translateY(-16px) scale(1.05)'
                    : 'rotate(-6deg) translateX(-40px) translateY(0px)',
                  boxShadow:
                    '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)',
                }}
              >
                <div className="p-3">
                  ...
                  <div className="space-y-1.5">
                    <div className="bg-orange-50 rounded-lg p-1.5">
                      ...
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Sensory seeking decreased. Michael tolerates textures during meals.
                      </p>
                    </div>
                    ...
                    <div className="bg-orange-50/50 rounded-lg p-1.5 border border-orange-100 border-dashed">
                      <p className="text-[7px] font-medium text-[#F57D48]">Proposed Strategy #1</p>
                    </div>
                  </div>

                  <div className="mt-2 flex items-center gap-1.5">
                    <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-3/5 bg-gradient-to-r from-[#F57D48] to-[#FF9C7A] rounded-full" />
                    </div>
              ...
              <div
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-transform duration-300 ease-out"
                onMouseEnter={() => setActiveCard('SALT')}
                onMouseLeave={() => setActiveCard(null)}
                onClick={() => setActiveCard('SALT')}
                style={{
                  zIndex: isSALTActive ? 50 : 20,
                  transform: isSALTActive
                    ? 'translateY(-16px) scale(1.05)'
                    : 'rotate(2deg) translateX(20px) translateY(-20px)',
                  boxShadow:
                    '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)',
                }}
              >
                <div className="p-3">
                  ...
                  <div className="space-y-1.5">
                    <div className="bg-teal-50 rounded-lg p-1.5">
                      ...
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        23 new words this month. Michael initiated conversation with a peer.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-1.5">
                      <p className="text-[8px] font-semibold text-gray-700 mb-0.5">Next Focus</p>
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Work on two-word combinations like &quot;more juice.&quot;
                      </p>
                    </div>

                    <div className="bg-teal-50/50 rounded-lg p-1.5 border border-teal-100 border-dashed">
                      <p className="text-[7px] font-medium text-[#14B8A6]">Proposed Strategy #1</p>
                    </div>
                  </div>

                  <div className="mt-2 flex items-center gap-1.5">
                    <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-[85%] bg-gradient-to-r from-[#14B8A6] to-teal-400 rounded-full" />
                    </div>
              ...
              <div
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-transform duration-300 ease-out"
                onMouseEnter={() => setActiveCard('ABA')}
                onMouseLeave={() => setActiveCard(null)}
                onClick={() => setActiveCard('ABA')}
                style={{
                  zIndex: isABAActive ? 50 : 14,
                  transform: isABAActive
                    ? 'translateY(-16px) scale(1.05)'
                ...
                <div className="p-3">
                  ...
                  <div className="space-y-1.5">
                    <div className="bg-purple-50 rounded-lg p-1.5">
                      ...
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Morning routine compliance up 60%. Fewer transition difficulties.
                      </p>
                    </div>
                    ...
                    <div className="bg-purple-50/50 rounded-lg p-1.5 border border-purple-100 border-dashed">
                      <p className="text-[7px] font-medium text-purple-600">Proposed Strategy #1</p>
                    </div>
                  </div>

                  <div className="mt-2 flex items-center gap-1.5">
                    <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-2/3 bg-gradient-to-r from-purple-400 to-purple-500 rounded-full" />
                    </div>
              ...
              <div
                className="absolute bg-white rounded-2xl w-[160px] md:w-[185px] cursor-pointer transition-transform duration-300 ease-out"
                onMouseEnter={() => setActiveCard('BIOMED')}
                onMouseLeave={() => setActiveCard(null)}
                onClick={() => setActiveCard('BIOMED')}
                style={{
                  zIndex: isBIOMEDActive ? 50 : 11,
                  transform: isBIOMEDActive
                    ? 'translateY(-16px) scale(1.05)'
                    : 'rotate(14deg) translateX(140px) translateY(30px)',
                  boxShadow:
                    '0 10px 30px -5px rgba(0, 0, 0, 0.2), 0 6px 12px -3px rgba(0, 0, 0, 0.1)',
                }}
              >
                <div className="p-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center">
                      <span className="text-white font-bold text-[9px]">BIOMED</span>
                    </div>
                    <span className="text-[8px] text-gray-400">30 days</span>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div className="bg-emerald-50 rounded-lg p-1.5">
                      <p className="text-[8px] font-semibold text-emerald-800 mb-0.5">
                        Patterns Emerging
                      </p>
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Energy improvements—stronger at exercises and music retention.
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 rounded-lg p-1.5">
                      <p className="text-[8px] font-semibold text-gray-700 mb-0.5">Next Focus</p>
                      <p className="text-[7px] text-gray-600 leading-relaxed">
                        Sugar cravings may indicate gut flora changes.
                      </p>
                    </div>

                    <div className="bg-emerald-50/50 rounded-lg p-1.5 border border-emerald-100 border-dashed">
                      <p className="text-[7px] font-medium text-emerald-600">Proposed Strategy #1</p>
                    </div>
                  </div>

                  <div className="mt-2 flex items-center gap-1.5">
                    <div className="flex-1 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-1/2 bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-full" />
                    </div>
            ...
            {/* Phone Frame - Same size as journaling phone, with increased height */}
            <div
              className="relative bg-gray-800 rounded-[2.5rem] p-2 mx-auto lg:mx-0 mt-8"
              style={{
                width: '260px',
                boxShadow:
                  '0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 12px 24px -8px rgba(0, 0, 0, 0.1)',
            ...
            >
              ...
              >
                ...
                <div className="bg-gradient-to-b from-amber-50 to-amber-100/50 p-3 pt-6">
                  ...
                  <p className="text-center text-gray-500 text-[8px]">
                    Observations &amp; Assessments Combined
                  </p>

                  {/* Legend */}
                  <div className="flex justify-center gap-3 mt-2">
                    <div className="flex items-center gap-1">
                      <div className="w-2 h-2 rounded-full bg-[#F57D48]" />
              ...
              {/* Badge - Attached to bottom of phone */}
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white px-4 py-2 rounded-full shadow-lg border border-gray-100 flex items-center gap-2 whitespace-nowrap z-20">
                <svg
        ...
        <p className="text-center text-gray-500 text-sm mt-16 max-w-xl mx-auto">
          No complicated setup. Just speak naturally about your day, and let AI organize your observations
